...
const translations: Translations = {
  en: {
    ...
    "home.reportCrisis.title": "Report a Conflict",
    ...
    "home.footer.map": "Nigeria Conflict Map",
    ...
    "nav.nigeriaCrisisMap": "Nigeria Conflict Map",
  ...
  ig: {
    ...
    "layout.sidebar.dataManagement": "Njikwa Data",
  ...
  ha: {
    ...
    "layout.sidebar.dataManagement": "Gudanar da Bayanai",
  ...
  yo: {
    ...
    "layout.sidebar.dataManagement": "Ìṣàkóso Dátà",
